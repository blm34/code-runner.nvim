...
describe("code-runner.utils", function()
    ...
    describe("is_pwsh", function()
        ...
        it("returns true for 'C:\\Windows\\System32\\WindowsPowerShell\\powershell.exe'", function()
            vim_mock.get().o.shell = "C:\\Windows\\System32\\WindowsPowerShell\\powershell.exe"
            package.loaded["code-runner.utils"] = nil
            utils = require("code-runner.utils")
            assert.is_true(utils.is_pwsh)
        end)

        it("returns false for '/bin/bash'", function()
            vim_mock.get().o.shell = "/bin/bash"
            package.loaded["code-runner.utils"] = nil
            utils = require("code-runner.utils")
            assert.is_false(utils.is_pwsh)
        end)

        it("returns false for '/bin/zsh'", function()
            vim_mock.get().o.shell = "/bin/zsh"
            package.loaded["code-runner.utils"] = nil
            utils = require("code-runner.utils")
            assert.is_false(utils.is_pwsh)
        end)
